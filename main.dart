...
// PRIMEIRA PÁGINA ou TELA ou INTERFACE ou Activity
                      ...
                      builder: (context) => RaisedButton(
                          ...
                          onPressed: () {
                            if ((emailController.text == "1") &&
                              ...
                              //setState(() {msg = "Usuário ou senha incorretos";});
                            }
                          }))),
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 10,),
            Text("nathaly_kaubatz", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
            Text(lista[index].subtitulo, style: TextStyle(fontSize: 16),)
          ],
        ),
      ),
    );
            ...
            children: <Widget>[
              ...
              Flexible(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      lista.add(Item(Icons.person_outline, "nathaly_kaubatz", txtSubtitulo.text));
                      txtSubtitulo.text = "";
                    });
                  },
                ),
